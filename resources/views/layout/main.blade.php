...
<head>
  ...
  <title>Bromo Creative</title>

  <!-- Google Font: Source Sans Pro -->
  <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700&display=fallback">
  <!-- Font Awesome -->
  <link rel="stylesheet" href="{{ asset('lte/plugins/fontawesome-free/css/all.min.css') }}">
  <link rel="stylesheet" href="{{ asset('lte\plugins\font-awesome-4.7.0\css\font-awesome.css') }}">
  <!-- Ionicons -->
...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="{{ asset('lte/dist/img/bromo.png') }}" alt="" height="60" width="60">
  </div>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="{{ route('admin.dashboard') }}" class="d-block"> {{ session('username') }}</a>
        </div>
      </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{ route('admin.kota') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Menu Penjemputan</p>
                </a>
              </li>
            </ul>
          </li>
          ...
          <li class="nav-item">
            <a href="#" class="nav-link">
              ...
              <p>Riwayat
                <i class="right fas fa-angle-left"></i>
                <span class="badge badge-info right">{{ $proses }}</span>
              </p>
            </a>
            <ul class="nav nav-treeview">
              <li class="nav-item">
